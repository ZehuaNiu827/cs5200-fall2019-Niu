...
INSERT INTO `person` VALUES (12,'Alice','Wonder','alice','alice','alice@wonder.com',NULL),
                        ...
                        (34,'Charles','Garcia','charlie','charlie','charlie@garcia.com',NULL),
...
INSERT INTO `website` VALUES (123,'Facebook','an online social media and social networking ',NOW(),NOW(),1234234),
...
INSERT INTO `page` VALUES (123,'Home','Landing Page','2019-09-05','2019-10-09',123434,567),
						(234,'About',' Website description','2019-09-05','2019-10-09',234545,678),
                        (345,'Contact','Addresses, phones and contact info','2019-09-05','2019-10-09',345656,345),
                        (456,' Preferences',' Where users can configure their preferences','2019-09-05','2019-10-09',456776,456),
                        (567,' Profile',' Users can configure their personal information','2019-09-05','2019-10-08',567878,567);

INSERT INTO `widget` VALUES (123,'head123',NULL,NULL,NULL,NULL,'Welcome',0,'HEADING',NULL,NULL,NULL,NULL,NULL,2,123),
						(234,'post234',NULL,NULL,NULL,NULL,'<p>Lorem</p>',0,'HTML',NULL,NULL,NULL,NULL,NULL,0,234),
						(345,'head345',NULL,NULL,NULL,NULL,'Hi',1,'HEADING',NULL,NULL,NULL,NULL,NULL,2,345),
                        (456,'intro456',NULL,NULL,NULL,NULL,'<h1>Hi</h1>',2,'HTML',NULL,NULL,NULL,NULL,NULL,0,345),
                        (567,'image345',50,100,NULL,NULL,NULL,3,NULL,NULL,NULL,NULL,'/img/567.png',NULL,0,345),
                        (678,'video456',400,300,NULL,NULL,NULL,0,NULL,'https://youtu.be/h6 7VX51QXiQ',NULL,NULL,NULL,NULL,2,456);

INSERT INTO `address` VALUES (1,'123 Adam St.',NULL,'Alton',NULL,'01234',1,12),
						(2,'234 Birch St.',NULL,' Boston',NULL,'02345',0,12),
                        (3,'345 Charles St.',NULL,'Chelms',NULL,'03455',1,23),
                        (4,'456 Down St.',NULL,'Dalton,',NULL,'04566',0,23),
                        (5,'543 East St.',NULL,'Everett',NULL,'01112',0,23),
                        (6,'654 Frank St.',NULL,'Foulton,',NULL,'04322',1,34);

INSERT INTO `phone` VALUES (1,'123-234-3456',1,12),
						(2,'234-345-4566',0,12),
						(3,'345-456-5677',1,23),
                        (4,'321-432-5435',1,34),
                        (5,'432-432-5433',0,34),
